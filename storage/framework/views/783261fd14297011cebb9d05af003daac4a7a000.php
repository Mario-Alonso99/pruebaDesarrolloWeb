...
<html lang="en">
  <head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Prueba Desarrollo</title>
    ...
    <nav class="flex py-5 bg-indigo-500 text-white">
      ...
      <ul class="w-1/2 px-16 ml-auto flex justify-end pt-1">
        <?php if(auth()->check()): ?>
          ...
          <li class="mx-6">
            <a href="<?php echo e(route('consulta.index')); ?>" class="font-semibold 
...
</html><?php /**PATH C:\xampp\htdocs\laravel\pruebadesarrolloweb\resources\views/layouts/app.blade.php ENDPATH**/ ?>